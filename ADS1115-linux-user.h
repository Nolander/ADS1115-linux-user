...
#define ADS1115_COMPARE_AIN0toAIN1 ((0b000) << 12)
#define ADS1115_COMPARE_AIN0toAIN3 ((0b001) << 12)
#define ADS1115_COMPARE_AIN1toAIN3 ((0b010) << 12)
#define ADS1115_COMPARE_AIN2toAIN3 ((0b011) << 12)
#define ADS1115_COMPARE_AIN0toGND ((0b100) << 12)
#define ADS1115_COMPARE_AIN1toGND ((0b101) << 12)
#define ADS1115_COMPARE_AIN2toGND ((0b110) << 12)
#define ADS1115_COMPARE_AIN3toGND ((0b111) << 12)

#define ADS1115_RANGEmV_FS6144 ((0b000) << 9)
#define ADS1115_RANGEmV_FS4096 ((0b001) << 9)
#define ADS1115_RANGEmV_FS2048 ((0b010) << 9)
#define ADS1115_RANGEmV_FS1024 ((0b011) << 9)
#define ADS1115_RANGEmV_FS0512 ((0b100) << 9)
#define ADS1115_RANGEmV_FS0256 ((0b101) << 9)

#define ADS1115_SINGLESHOT_CONVERSION (1<<8)
#define ADS1115_CONTINUOUS_CONVERSION (0<<8)
...
#define ADS1115_COMP_LAT (1<<2)

#define ADS1115_COMP_QUE_DISABLE (0b011)
